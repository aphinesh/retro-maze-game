...
def lvl_one(wall_pos):
    ...
    enter_one = font_one.render("PRESS ENTER TO GO", True, (255, 255, 255))
    enter_two = font_one.render("THROUGH THE", True, (255, 255, 255))
    enter_three = font_one.render("DOOR", True, (255, 255, 255))
    ...
    while run:
        ...
        if player_rect.y > 400:
            ...
            screen.blit(enter_two, (1060, 500))
            screen.blit(enter_three, (1160, 580))
        ...
        for event in pygame.event.get():
            #if they press enter after reaching the door it goes to lvl 2
            if event.type == pygame.KEYDOWN and event.key == pygame.K_RETURN and door == open_door:
                run = False
                return "lvl_two"
...
def lvl_two(wall_pos):
    ...
    #loading note with colour code on it
    colour_code = pygame.image.load("colour_code.png")
    ...
    def main_instructions():
        ...
        inventory_access_txt_one = font.render("=>  PRESS I TO", True, (255, 255, 255))
        inventory_access_txt_two = font.render("ACCESS YOUR", True, (255, 255, 255))
        inventory_access_txt_three = font.render("INVENTORY", True, (255, 255, 255))
        pickup_instruction_one = font.render("=>  PRESS P TO", True, (255, 255, 255))
        pickup_instruction_two = font.render("PICKUP ITEMS", True, (255, 255, 255))
        screen.blit(inventory_access_txt_one, (1280, 650))
        screen.blit(inventory_access_txt_two, (1328, 685))
        screen.blit(inventory_access_txt_three, (1328, 720))
        screen.blit(pickup_instruction_one, (1280, 785))
        screen.blit(pickup_instruction_two, (1328, 820))
    ...
    def inventory_instructions():
        font = pygame.font.Font(None, 40)
        inventory_close_txt_one = font.render("=>  PRESS I TO", True, (255, 255, 255))
        inventory_close_txt_two = font.render("CLOSE", True, (255, 255, 255))
        inventory_close_txt_three = font.render("INVENTORY", True, (255, 255, 255))
        ...
        screen.blit(inventory_close_txt_one, (1280, 470))
        screen.blit(inventory_close_txt_two, (1328, 505))
        screen.blit(inventory_close_txt_three, (1328, 540))
        screen.blit(inspect_instruction_one, (1280, 605))
        screen.blit(inspect_instruction_two, (1328, 640))
        screen.blit(move_instruction_one, (1280, 705))
        screen.blit(move_instruction_two, (1328, 740))
        screen.blit(move_instruction_three, (1328, 775))
        screen.blit(move_instruction_four, (1328, 810))

    def monitor_instructions():
        font = pygame.font.Font(None, 30)
        rgb_txt_one = font.render("=>   PRESS R, G, OR B", True, (255, 255, 255))
        rgb_txt_two = font.render("TO TYPE COLOUR", True, (255, 255, 255))
        rgb_txt_three = font.render("CODE", True, (255, 255, 255))
        ...
        backspace_txt_one = font.render("=>   PRESS BACKSPACE", True, (255, 255, 255))
        backspace_txt_two = font.render("TO GO BACK", True, (255, 255, 255))
        escape_txt_one = font.render("=>   PRESS ESCAPE", True, (255, 255, 255))
        escape_txt_two = font.render("TO CLOSE", True, (255, 255, 255))
        screen.blit(rgb_txt_one, (1280, 450))
        screen.blit(rgb_txt_two, (1323, 480))
        screen.blit(rgb_txt_three, (1323, 510))
        screen.blit(colour_check_txt_one, (1280, 570))
        screen.blit(colour_check_txt_two, (1323, 600))
        screen.blit(colour_check_txt_three, (1323, 630))
        screen.blit(backspace_txt_one, (1280, 690))
        screen.blit(backspace_txt_two, (1323, 720))
        screen.blit(escape_txt_one, (1280, 780))
        screen.blit(escape_txt_two, (1323, 810))
    ...
    note_inventory = pygame.image.load("colour_code.png")
    ...
    # Note Popup
    note_popup = pygame.image.load("colour_code.png")
    note_popup = pygame.transform.scale(note_inventory, (500, 245))
    note_popup_rect = note_popup.get_rect(topleft = (510, 250))
    #note for the treat popup
    note_explanation_one = font.render("some sort of a secret code.", True, (255, 255, 255))
    note_explanation_two = font.render("might be of use later...", True, (255, 255, 255))
    ...
    computer_input = ["_", " ", " ", " ", " ", " "]
    computer_input_pos = [(510, 360), (575, 360), (640, 360), (705, 360), (770, 360), (835, 360)]
    ...
    while run:
        ...
        if inventory_open and not end and not end_win:
            ...
            if show_item == "note":
                pygame.draw.rect(screen, (60, 30, 10), popup_rect)
                pygame.draw.rect(screen, (10, 10, 10), popup_rect, 20)
                screen.blit(note_explanation_one, (600, 480))
                screen.blit(note_explanation_two, (630, 525))
        ...
        if monitor_open and not end and not end_win:
            ...
            screen.blit(monitor_txt_one, (500, 280))    #text on monitor
            # six white squares
            ...
            for i in range(6):
                if computer_input[i] == "R":
                    current_letter_colour = computer_code_font.render(computer_input[i], True, (255, 0, 0))
                elif computer_input[i] == "G":
                    current_letter_colour = computer_code_font.render(computer_input[i], True, (0, 255, 0))
                elif computer_input[i] == "B":
                    current_letter_colour = computer_code_font.render(computer_input[i], True, (0, 0, 255))   
                else:
                    current_letter_colour = computer_code_font.render(computer_input[i], True, (0, 0, 0))
                screen.blit(current_letter_colour, computer_input_pos[i])
            if not valid_code_input:
                small_computer_font = pygame.font.SysFont("consolas", 20)
                invalid_colour_txt = small_computer_font.render("Invalid input", True, (255, 0, 0))
                screen.blit(invalid_colour_txt, (600, 430))
            if wrong_colour_code:
                small_computer_font = pygame.font.SysFont("consolas", 20)
                wrong_colour_txt = small_computer_font.render("Wrong colour code", True, (255, 0, 0))
                screen.blit(wrong_colour_txt, (600, 430))
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN and door == open_door and not inventory_open and not end and not end_win:
                    timer_running = False
                    print(f"Time Taken: {minutes_left}mins {seconds_left}sec")
                    win = True
                #if they pick up the treat
                if event.key == pygame.K_p and treat_interact == True and not inventory_open and not end and not end_win:
                    if add_item("treat"):
                        display_treat = False
                        treat_interact = False
                #if they pick up the key
                if event.key == pygame.K_p and key_interact == True and not inventory_open and not end and not end_win:
                    if add_item("key"):
                        display_key = False
                        key_interact = False
                        key_obtained = True
                #if they pick up the note with the colour code
                if event.key == pygame.K_p and colour_code_interact == True and not inventory_open and not end and not end_win:
                    if add_item("note"):
                ...
                if event.key == pygame.K_RETURN and security_door_interact and key_obtained and not inventory_open:
                    ...
                    security_door_interact = False
                #opening and closing inventory using 'i'
                if event.key == pygame.K_i and not monitor_open:
            ...
            #when monitor is open
            if event.type == pygame.KEYDOWN and monitor_open:
                if wrong_colour_code and event.key != pygame.K_RETURN:
                    wrong_colour_code = False
                if event.key == pygame.K_RETURN and not correct_code:
                    wrong_colour_code = True
                if current_letter < 5:
                    if event.key == pygame.K_r:
                        computer_input[current_letter] = "R"
                        computer_input[current_letter + 1] = "_"
                        current_letter += 1
                        valid_code_input = True
                        ...
                        computer_input[current_letter] = " "
                        computer_input[current_letter - 1] = "_"
                        current_letter -= 1
                    elif event.key == pygame.K_BACKSPACE or event.key == pygame.K_RETURN:
                        valid_code_input = True
                    else:
                        valid_code_input = False
                elif current_letter == 5:
                    if event.key == pygame.K_r  and computer_input[current_letter] == "_":
                        computer_input[current_letter] = "R"
                        valid_code_input = True
                    elif event.key == pygame.K_b  and computer_input[current_letter] == "_":
                        computer_input[current_letter] = "B"
                        valid_code_input = True
                    elif event.key == pygame.K_g  and computer_input[current_letter] == "_":
                        computer_input[current_letter] = "G"
                        valid_code_input = True
                    elif event.key == pygame.K_BACKSPACE and computer_input[current_letter] == "_":
                        computer_input[current_letter] = " "
                        computer_input[current_letter - 1] = "_"
                        current_letter -= 1
                        valid_code_input = True
                    elif event.key == pygame.K_BACKSPACE:
                        computer_input[current_letter] = "_"
                        valid_code_input = True
                    elif event.key == pygame.K_BACKSPACE or event.key == pygame.K_r or event.key == pygame.K_b or event.key == pygame.K_g or event.key == pygame.K_RETURN:
                        valid_code_input = True
                    else:
                        valid_code_input = False
